...
use crate::subagent::types::{
    ModelConfig, PermissionMode, SubagentDefinition, SubagentSource, SubagentType,
};
...
impl SubagentRegistry {
    ...
    fn register_builtin(&mut self) {
        ...
        self.builtin_agents
            .insert("fork".to_string(), crate::subagent::types::FORK_AGENT);
    ...
    pub fn get_agent(&self, agent_type: &SubagentType) -> Option<&SubagentDefinition> {
        match agent_type {
            ...
            SubagentType::GeneralPurpose => self.builtin_agents.get("general-purpose"),
            SubagentType::Custom(name) => self
                .custom_agents
                .get(name)
    ...
    pub fn is_valid_agent_type(&self, agent_type: &str) -> bool {
        self.builtin_agents.contains_key(agent_type) || self.custom_agents.contains_key(agent_type)
    }
...
mod tests {
    ...
    fn test_parse_subagent_type() {
        ...
        assert_eq!(
            parse_subagent_type("general-purpose"),
            SubagentType::GeneralPurpose
        );
        assert_eq!(
            parse_subagent_type("custom-agent"),
